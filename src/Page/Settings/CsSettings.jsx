...
const CsSettings = () => {
    ...
    const topbadrdata = { title: 'Settings' };
    ...
    return (
        <div className="p-6 md:p-8 bg-[#F6F8FA] min-h-screen w-full">
            ...
            <div className="grid grid-cols-1 mt-[100px] sm:grid-cols-2 gap-6 md:gap-8 max-w-2xl mx-auto">
                <div className="bg-white max-w-[308px] rounded-lg p-6 md:p-8 text-center flex flex-col items-center justify-start  duration-200 cursor-pointer" onClick={() => navigate("/intelliassign")}>
                    ...
                    <p className="text-[16px] font-poppins font-normal leading-[100%] tracking-[0px] text-[#667085] text-center">
                        Auto-assign conversations within your team
                    </p>
                </div>

                <div className="bg-white rounded-lg max-w-[308px] p-6 md:p-8 text-center flex flex-col items-center justify-start transition-shadow duration-200 cursor-pointer" onClick={() => navigate("/AutoResponse")}>
                    <div className="mb-[20px]">
                        <img src='/email-autoresponder.png' />
                    </div>
                    <h3 className="text-[20px] font-poppins font-medium leading-[100%] tracking-[0px] text-[#000000] text-center mb-4">
                        Auto Response
                    </h3>
                    ...
                    <p className="text-[16px] font-poppins font-normal leading-[100%] tracking-[0px] text-[#667085] text-center">
                        customize the auto-response journey
                    </p>
