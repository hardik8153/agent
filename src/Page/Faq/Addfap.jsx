...
const AddFaq = ({ onClose }) => {
    ...
    return (
        <div className="fixed inset-0 flex justify-end bg-black bg-opacity-50 z-50">
            ...
            <div className="bg-[#F6F8FA] w-full overflow-y-auto max-h-full max-w-md h-full shadow-xl flex flex-col transition-transform transform duration-300 ease-in-out">
                <div className="p-6 pb-2">
                    <h2 className="text-[20px] leading-[20px] tracking-[0] font-Poppins font-medium text-black">
                        Add FAQ
                    </h2>
                    <hr className='mt-6 mb-1 border-t border-gray-200' />
                </div>
                ...
                <form className="flex flex-col flex-grow p-6 pt-2" onSubmit={handleSaveClick}>
                    <div className="mb-4">
                        <label
                            htmlFor="faq-title"
                            className="block text-[10px] leading-[10px] tracking-[0] font-Poppins font-normal text-[#667085] mb-2"
                        >
                            Title
                        </label>
